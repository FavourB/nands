...
const team = [
  ...
  },
  {
    ...
    description: "Frontend Developer | Wordpress Expert | Next | Vue",
    img: zino,
  },
  {
    name: "Favour Bawa",
...
const useStyles = makeStyles((theme) => ({
  ...
  caption: {
    ...
    right: 0,
    background:
      "linear-gradient(270deg, rgba(0,0,0,.3), rgba(0,0,0,0.8) 70.71%)",
          ...
          <Grid item sm={12} md={12}>
            ...
            <ListItem className="px-0">
              ...
              <Typography variant="h6">
                Visionary, Curious, and Innovative
              </Typography>
            </ListItem>
            <ListItem className="px-0">
              <ListItemIcon className={classes.icon}>
          ...
          <Grid item sm={12} md={12} className={classes.btnContainer}>
            ...
            <Grid item xs={12} md={12} sm={4}>
              <Button
                ...
                size="large"
                color="secondary"
                className={`${classes.contactus} text-nowrap`}
              >
                <Link
                  to="contactus"
                  spy={true}
            ...
            <Grid item xs={12} md={12} sm={4}>
              <Button
                ...
                color="secondary"
                style={{ color: "#fff" }}
                className={`${classes.hireus} text-nowrap`}
                target="_blank"
                href="https://www.upwork.com/o/companies/~01fe351fce0ea3fd23"
              >
                Hire Us
              </Button>
            </Grid>
